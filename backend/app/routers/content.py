...
11. 메뉴를 언급할 때는 반드시 사장님이 등록한 메뉴({req.store_menus})만 사용하세요. 존재하지 않는 가상의 메뉴를 만들어내지 마세요. 등록된 메뉴가 홍보 내용과 어울리지 않으면 메뉴명 없이 일반적으로 작성하세요.
12. 해시태그는 반드시 별도 섹션(---추천 해시태그---)에 작성하세요.
